...
set.seed(0)
dura_clus <- kcca(train_data_dura, k=3, kccaFamily("kmeans"))
pace_clus <- kcca(train_data_pace, k=3, kccaFamily("kmeans"))
sect_clus <- kcca(train_data_sect, k=3, kccaFamily("kmeans"))
loud_clus <- kcca(train_data_loud, k=3, kccaFamily("kmeans"))
pitches_clus <- kcca(train_data_pitches, k=3, kccaFamily("kmeans"))
timbre_clus <- kcca(train_data_timbre, k=3, kccaFamily("kmeans"))
