library(rhdf5)
# define working path
train_data_path <- "/Users/yueqizhang/Documents/w5243 ads/project4/Fall2016-proj4-Yueqi-Zhang/data/Project4_data/data"
test_data_path <- "/Users/yueqizhang/Documents/w5243 ads/project4/Fall2016-proj4-Yueqi-Zhang/data/test/TestSongFile100"
pca_matrix_path <- "/Users/yueqizhang/Documents/w5243 ads/project4/Fall2016-proj4-Yueqi-Zhang/lib"
data_output_path <- "/Users/yueqizhang/Documents/w5243 ads/project4/Fall2016-proj4-Yueqi-Zhang/data"
...
for(i in 1:file_num){
  if(! i %in% ab_songs){
    data <- h5read(file_names[i], "analysis")
    H5close()
    song_id <- substring(file_names[i], nchar(file_names[i])-20, nchar(file_names[i]))
